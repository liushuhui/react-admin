(self["webpackChunkreact_admin"] = self["webpackChunkreact_admin"] || []).push([[938],{
...
__webpack_require__.d(__webpack_exports__, {
  "uA": () => (/* binding */ inputToRGB)
});

// UNUSED EXPORTS: isValidCSSUnit, stringInputToObject
...
function inputToRGB(color) {
    ...
    if (typeof color === 'object') {
        if (isValidCSSUnit(color.r) && isValidCSSUnit(color.g) && isValidCSSUnit(color.b)) {
            rgb = (0,conversion/* rgbToRgb */.rW)(color.r, color.g, color.b);
            ok = true;
            format = String(color.r).substr(-1) === '%' ? 'prgb' : 'rgb';
        }
        else if (isValidCSSUnit(color.h) && isValidCSSUnit(color.s) && isValidCSSUnit(color.v)) {
            s = (0,util/* convertToPercentage */.JX)(color.s);
            v = (0,util/* convertToPercentage */.JX)(color.v);
            rgb = (0,conversion/* hsvToRgb */.WE)(color.h, s, v);
            ok = true;
            format = 'hsv';
        }
        else if (isValidCSSUnit(color.h) && isValidCSSUnit(color.s) && isValidCSSUnit(color.l)) {
            s = (0,util/* convertToPercentage */.JX)(color.s);
            l = (0,util/* convertToPercentage */.JX)(color.l);
            rgb = (0,conversion/* hslToRgb */.ve)(color.h, s, l);
            ok = true;
            format = 'hsl';
        }
...
function stringInputToObject(color) {
    ...
    if (match) {
        return {
            r: (0,conversion/* parseIntFromHex */.VD)(match[1]),
            g: (0,conversion/* parseIntFromHex */.VD)(match[2]),
            b: (0,conversion/* parseIntFromHex */.VD)(match[3]),
            a: (0,conversion/* convertHexToDecimal */.T6)(match[4]),
    ...
    if (match) {
        return {
            r: (0,conversion/* parseIntFromHex */.VD)(match[1] + match[1]),
            g: (0,conversion/* parseIntFromHex */.VD)(match[2] + match[2]),
            b: (0,conversion/* parseIntFromHex */.VD)(match[3] + match[3]),
            a: (0,conversion/* convertHexToDecimal */.T6)(match[4] + match[4]),
            format: named ? 'name' : 'hex8',
        };
    }
...
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = ((/* unused pure expression or super */ null && (alignElement)));
